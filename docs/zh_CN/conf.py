...
latex_documents = [
    (master_doc, 'canvas.tex', u'canvas Documentation',
     author, 'manual'),
]
...
man_pages = [
    (master_doc, 'canvas', u'canvas Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'canvas', u'canvas Documentation',
     author, 'canvas', 'One line description of project.',
     'Miscellaneous'),
]
